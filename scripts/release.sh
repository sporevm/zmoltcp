...
Environment:
  ...
  RELEASE_BRANCH_PREFIX Branch prefix (default: lox/release-v)
EOF
}
...
branch_prefix="${RELEASE_BRANCH_PREFIX:-lox/release-v}"
dry_run=0
requested_version=""
current_manifest=""
tmp_manifest=""
...
Next steps:
  ...
  gh pr create --repo lox/zmoltcp --base ${base_branch} --head ${release_branch} --title "chore: release ${tag_name}"
EOF
